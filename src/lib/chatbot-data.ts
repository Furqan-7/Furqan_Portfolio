// Chatbot Knowledge Base - Comprehensive information about Furqan Bodarni
...
export const CHATBOT_CONTEXT = {
  ...
  personal: {
    ...
    currentStatus: "Currently pursuing Computer Science and building AI-powered web products.",
    yearsOfExperience: "1+",
    projectsBuilt: "5+",
    linesOfCode: "100,000+",
  ...
  social: {
    ...
    instagram: "https://www.instagram.com/mr__furqan7/",
    portfolio: "https://furqanbodarni.vercel.app",
    email: "bodarnifurqan07@gmail.com",
  },
  ...
  sections: {
    ...
    about: { name: "About Me", link: "#about", description: "Learn more about Furqan" },
    ...
    services: { name: "Services", link: "#services", description: "What Furqan offers" },
...
export const QUICK_RESPONSES: Record<string, string> = {
  // Greetings
  'hi': "Hey there! 👋 I'm Furqan's AI assistant. How can I help you learn more about him today?",
  'hello': "Hello! Welcome to Furqan's portfolio. What would you like to know?",
  'hey': "Hi! I'm here to tell you all about Furqan. Ask me anything!",
  'good morning': "Good morning! ☀️ Welcome to Furqan's portfolio. How can I assist you today?",
  'good afternoon': "Good afternoon! Welcome! What would you like to know about Furqan?",
  ...
  // About Questions
  'who are you': `I'm an AI assistant for **Furqan Bodarni**, a ${CHATBOT_CONTEXT.personal.jobTitle} based in ${CHATBOT_CONTEXT.personal.location}. I can tell you about his skills, projects, experience, and more!`,
  'who is furqan': `**Furqan Bodarni** is a ${CHATBOT_CONTEXT.personal.jobTitle} with ${CHATBOT_CONTEXT.personal.yearsOfExperience} years of experience. ${CHATBOT_CONTEXT.personal.bio}`,
  'tell me about yourself': `**Furqan Bodarni** is a ${CHATBOT_CONTEXT.personal.jobTitle} based in ${CHATBOT_CONTEXT.personal.location}.\n\n${CHATBOT_CONTEXT.personal.bio}\n\n📊 **Quick Stats:**\n• ${CHATBOT_CONTEXT.personal.yearsOfExperience} years of experience\n• ${CHATBOT_CONTEXT.personal.projectsBuilt} projects built\n• Currently: ${CHATBOT_CONTEXT.personal.currentStatus}`,
  'tell me about furqan': `**Furqan Bodarni** is a passionate ${CHATBOT_CONTEXT.personal.jobTitle} with ${CHATBOT_CONTEXT.personal.yearsOfExperience} years of experience building scalable web applications and AI-powered solutions.\n\n${CHATBOT_CONTEXT.personal.bio}`,
  'introduce yourself': `Hi! I'm the AI assistant for **Furqan Bodarni**. Furqan is a ${CHATBOT_CONTEXT.personal.jobTitle} who specializes in building modern web applications and AI solutions. I can help you learn about his skills, projects, and how to work with him!`,
  'what do you do': `Furqan is a **${CHATBOT_CONTEXT.personal.jobTitle}** who builds:\n\n• Modern web applications with React/Next.js\n• AI-powered solutions and chatbots\n• Full-stack applications with scalable backends\n\nHe's passionate about creating innovative digital experiences!`,

  // Contact Questions
  'email': `📧 You can reach Furqan at: **${CHATBOT_CONTEXT.personal.email}**`,
  'phone': `📱 Furqan's phone number is: **${CHATBOT_CONTEXT.personal.phone}**`,
  'phone number': `📱 Furqan's phone number is: **${CHATBOT_CONTEXT.personal.phone}**`,
  'contact': `**Get in Touch:**\n\n📧 Email: ${CHATBOT_CONTEXT.personal.email}\n📱 Phone: ${CHATBOT_CONTEXT.personal.phone}\n\n👉 [Go to Contact Section](#contact)`,
  'how can i contact you': `**Contact Furqan:**\n\n📧 Email: ${CHATBOT_CONTEXT.personal.email}\n📱 Phone: ${CHATBOT_CONTEXT.personal.phone}\n💼 LinkedIn: ${CHATBOT_CONTEXT.social.linkedin}\n\n👉 [Go to Contact Section](#contact)`,
  'how to reach you': `**Reach out to Furqan:**\n\n📧 Email: ${CHATBOT_CONTEXT.personal.email}\n📱 Phone: ${CHATBOT_CONTEXT.personal.phone}\n\nHe typically responds within ${CHATBOT_CONTEXT.personal.responseTime}!`,

  // Location Questions
  'location': `📍 Furqan is based in **${CHATBOT_CONTEXT.personal.location}**, but works remotely with clients worldwide!`,
  'where are you from': `📍 Furqan is from **${CHATBOT_CONTEXT.personal.location}**. He's available for remote work globally!`,
  'where do you live': `📍 Furqan lives in **${CHATBOT_CONTEXT.personal.location}**. He works remotely with clients from all over the world!`,
  'where are you located': `📍 Furqan is located in **${CHATBOT_CONTEXT.personal.location}**.\n\n🌍 Timezone: ${CHATBOT_CONTEXT.personal.timezone}\n🏠 Work Style: Remote-first`,
  'which country': `🇮🇳 Furqan is based in **India**, specifically in ${CHATBOT_CONTEXT.personal.location}. He works with clients worldwide!`,

  // Availability & Hiring
  'available': CHATBOT_CONTEXT.personal.availableForWork
    ? "✅ **Yes!** Furqan is currently available for freelance, contract, and full-time opportunities. Reach out to discuss your project!"
    : "⏳ Furqan is currently busy with existing commitments, but feel free to reach out for future projects.",
  'are you available': CHATBOT_CONTEXT.personal.availableForWork
    ? "✅ **Yes!** Furqan is currently available for new projects and opportunities!"
    : "⏳ Currently busy, but open to discussing future opportunities.",
  'can i hire you': `Yes! Furqan is ${CHATBOT_CONTEXT.personal.availableForWork ? '**currently available**' : 'open to opportunities'}.\n\n**To hire:**\n1. Go to the Contact Section\n2. Send a message describing your project\n3. He'll respond within ${CHATBOT_CONTEXT.personal.responseTime}\n\n👉 [Go to Contact Section](#contact)`,
  'how can i hire you': `**How to Hire Furqan:**\n\n1. 📝 Visit the Contact Section\n2. 💬 Describe your project requirements\n3. 📧 Or email directly: ${CHATBOT_CONTEXT.personal.email}\n\nHe responds within ${CHATBOT_CONTEXT.personal.responseTime}!\n\n👉 [Go to Contact Section](#contact)`,
  'hire': `**Hire Furqan:**\n\n✅ Currently available for:\n${CHATBOT_CONTEXT.personal.workPreference.map(w => `• ${w}`).join('\n')}\n\n📧 Email: ${CHATBOT_CONTEXT.personal.email}\n👉 [Go to Contact Section](#contact)`,
  'looking for developer': `**Great!** Furqan is a ${CHATBOT_CONTEXT.personal.jobTitle} available for hire!\n\n**Services:**\n• Full Stack Development\n• AI/ML Integration\n• SaaS Development\n• API Development\n\n👉 [Go to Contact Section](#contact)`,
  'need a developer': "**Furqan can help!** He's an experienced Full Stack & AI Developer.\n\n👉 [Go to Contact Section](#contact) to discuss your project!",

  // Skills Questions
  'what are your skills': `**Furqan's Key Skills:**\n\n🎨 **Frontend:** React, Next.js, TypeScript, Tailwind CSS\n⚙️ **Backend:** Node.js, Python, Express, FastAPI\n🗄️ **Database:** PostgreSQL, MongoDB, Prisma\n🤖 **AI/ML:** OpenAI, LangChain, TensorFlow\n☁️ **Cloud:** Vercel, AWS, Docker\n\n👉 [View All Skills](#skills)`,
  'tech stack': `**Furqan's Tech Stack:**\n\n🎨 **Frontend:** React, Next.js, TypeScript, Tailwind CSS, Framer Motion\n⚙️ **Backend:** Node.js, Python, Express.js, FastAPI\n🗄️ **Databases:** PostgreSQL, MongoDB, Supabase\n🤖 **AI/ML:** OpenAI API, LangChain, TensorFlow\n☁️ **DevOps:** Vercel, AWS, Docker, GitHub Actions\n\n**Favorite Stack:** Next.js + TypeScript + Tailwind + PostgreSQL`,
  'what technologies do you use': `**Technologies Furqan Uses:**\n\n• **Languages:** JavaScript, TypeScript, Python\n• **Frontend:** React, Next.js, Tailwind CSS\n• **Backend:** Node.js, Express, FastAPI\n• **Databases:** PostgreSQL, MongoDB\n• **AI/ML:** OpenAI, LangChain, TensorFlow\n\n👉 [View All Skills](#skills)`,
  'favorite stack': "🛠️ Furqan's favorite stack is **Next.js + TypeScript + Tailwind CSS + PostgreSQL**. He loves the developer experience and performance this combination provides!",
  'what is your favorite technology': "🛠️ Furqan's favorite technologies are **Next.js** for frontend, **Node.js/Python** for backend, and **PostgreSQL** for database. For AI projects, he loves using **OpenAI API** and **LangChain**!",
  'best at': "Furqan excels at **Full Stack Development** (React/Next.js) and **AI/ML Integration**. He's built production applications used by real users!",
  'what are you best at': "Furqan is best at:\n\n🥇 **Full Stack Development** with React/Next.js\n🥈 **AI/ML Integration** for intelligent features\n🥉 **SaaS Platform Development**\n\nHe's shipped production projects!",

  // Project Questions
  'show me your projects': `**Furqan's Projects:**\n\n👉 [View All Projects](#projects)`,
  'what projects have you built': `**Projects Built by Furqan:**\n\nFurqan has built ${CHATBOT_CONTEXT.personal.projectsBuilt}+ production projects covering full-stack web apps and AI-powered solutions.\n\n👉 [View All Projects](#projects)`,
  'your work': `**Furqan's Work:**\n\nHe has built ${CHATBOT_CONTEXT.personal.projectsBuilt} production projects including AI applications and full-stack web products.\n\n👉 [View Projects](#projects)`,
  'portfolio': `**Furqan's Portfolio:**\n\nIncludes ${CHATBOT_CONTEXT.personal.projectsBuilt} projects ranging from AI-powered web apps to full-stack solutions.\n\n👉 [View All Projects](#projects)`,
  'what have you built': `**What Furqan Has Built:**\n\n🌐 Full-stack web applications\n🤖 AI-powered solutions and integrations\n📱 Responsive modern UIs\n⚙️ REST APIs and backend services\n\n👉 [View Projects](#projects)`,
  'what is devory': `**Devory** is a featured AI-driven platform. Check the projects section for full details.\n\n👉 [View Projects](#projects)`,
  ...
  'what is devory': `**Devory** is a flagship project - an AI-driven platform that helps students discover, build, and manage real-world technical projects.\n\n**Features:**\n• AI project recommendations\n• Progress tracking\n• Portfolio integration\n\n👉 [View Projects](#projects)`,
  ...
  // Services Questions
  'what services do you offer': `**Services Furqan Offers:**\n\n🌐 Full Stack Web Development\n🤖 AI/ML Integration\n📦 SaaS Platform Development\n🔗 API Design & Development\n🗄️ Database Design\n⚡ Performance Optimization\n🎨 UI/UX Development\n💬 Technical Consultation\n\n👉 [View Services](#services)`,
  'services': `**Furqan's Services:**\n\n• Full Stack Web Development\n• AI/ML Integration\n• SaaS Development\n• API Development\n• Database Design\n• UI/UX Development\n\n👉 [View Services](#services)`,
  'what can you do for me': `**How Furqan Can Help:**\n\n✅ Build custom web applications\n✅ Integrate AI features into your app\n✅ Design scalable databases\n✅ Create beautiful, responsive UIs\n✅ Optimize your application performance\n\n👉 [Contact for details](#contact)`,
  'can you build a website': "**Yes!** Furqan builds modern, responsive websites with:\n\n• React/Next.js\n• Custom designs\n• SEO optimization\n• Fast performance\n\n👉 [Go to Contact Section](#contact) to discuss your project!",
  'can you build an app': "**Absolutely!** Furqan can build:\n\n• Web applications (React/Next.js)\n• Full-stack apps with databases\n• AI-powered applications\n• SaaS platforms\n\n👉 [Go to Contact Section](#contact)",
  'do you do freelance': `**Yes!** Furqan is available for freelance work.\n\n**Work Types:**\n${CHATBOT_CONTEXT.personal.workPreference.map(w => `• ${w}`).join('\n')}\n\n👉 [Contact to discuss](#contact)`,

  // Experience Questions
  'experience': `**Furqan's Experience:**\n\n📅 ${CHATBOT_CONTEXT.personal.yearsOfExperience} years in software development\n🚀 ${CHATBOT_CONTEXT.personal.projectsBuilt} projects shipped\n🌐 Full-stack + AI expertise\n🎓 Computer Science (Pursuing)\n\n👉 [View Journey](#journey)`,
  'how much experience': `Furqan has **${CHATBOT_CONTEXT.personal.yearsOfExperience} years** of hands-on experience in full-stack development and AI/ML.\n\nHe has built ${CHATBOT_CONTEXT.personal.projectsBuilt} production projects!`,
  'years of experience': `📅 **${CHATBOT_CONTEXT.personal.yearsOfExperience} Years** of development experience.\n\nFurqan has been building production applications and growing his expertise ever since!`,
  'your journey': `**Furqan's Journey:**\n\nStarted web development → Learned React & Backend → Built production apps → AI/ML integration → Currently pursuing Computer Science\n\n👉 [View Full Journey](#journey)`,
  'how did you start coding': "Furqan started his coding journey with HTML, CSS, and JavaScript. His curiosity led him to React, then full-stack development, and now AI/ML integration. He believes in learning by building real projects!",

  // Education
  'education': `**Education:**\n\n🎓 Computer Science (Pursuing)\n📚 Self-taught developer\n🌐 Continuous learning through building projects\n\nFurqan believes in learning by doing!`,
  'where did you study': `🎓 Furqan is pursuing **Computer Science**.\n\nHe's also self-taught through online resources, documentation, and building real projects!`,
  ...
  'tell me something interesting': `**Fun Fact:** ${CHATBOT_CONTEXT.funFacts[Math.floor(Math.random() * CHATBOT_CONTEXT.funFacts.length)]}\n\nWant to know more about Furqan?`,
  'hobbies': `**Furqan's Interests:**\n\n• Building web applications\n• AI/ML exploration\n• Open source contribution\n• Learning new technologies\n• System design\n\nCoding is both his work and passion!`,

  // Common Questions
  'why should i hire you': `**Why Hire Furqan?**\n\n✅ ${CHATBOT_CONTEXT.personal.yearsOfExperience}+ years of experience\n✅ ${CHATBOT_CONTEXT.personal.projectsBuilt}+ production projects\n✅ Full-stack + AI expertise\n✅ Quick response time\n✅ Quality-focused approach\n✅ Clear communication\n\n👉 [Let's Discuss](#contact)`,
  'what makes you different': `**What Sets Furqan Apart:**\n\n🎯 Full-stack + AI/ML skills\n🚀 Focus on shipping real products\n💡 Modern tech stack expertise\n📈 Performance-oriented development\n🤝 Clear communication & reliability\n\nHe builds things that work and scale!`,
  'do you work remotely': `**Yes!** Furqan works remotely with clients worldwide.\n\n🌍 Available for global projects\n⏰ Flexible with timezones\n💬 Clear async communication\n\n👉 [Start a Project](#contact)`,
  'timezone': `🕐 Furqan's Timezone: **${CHATBOT_CONTEXT.personal.timezone}**\n\nHe's flexible and works with clients across different timezones!`,
  'languages you speak': `**Languages Furqan Speaks:**\n\n• English (Professional)\n• Hindi (Native)\n• Kannada (Native)`,
};

// Response templates for common intents
export const RESPONSE_TEMPLATES = {
  greeting: [
    "Hey there! 👋 I'm Furqan's AI assistant. How can I help you learn more about him today?",
    "Hello! Welcome to Furqan's portfolio. What would you like to know?",
    "Hi! I'm here to tell you all about Furqan. Ask me anything!",
    "Hey! Great to meet you. I can tell you about Furqan's skills, projects, experience, and more. What interests you?",
  ],

  farewell: [
    "Thanks for chatting! Feel free to reach out to Furqan at bodarnifurqan07@gmail.com. Have a great day! 👋",
    "Goodbye! Don't hesitate to contact Furqan if you have any opportunities or questions.",
    "Take care! Furqan would love to hear from you. Connect on LinkedIn or send an email!",
    "Thanks for visiting! Hope this was helpful. Reach out anytime! 🙌",
  ],

  unknown: [
    "I'm not sure about that specific question. Try asking about:\n\n• Skills & tech stack\n• Projects\n• Services\n• Contact info\n• How to hire\n\nOr reach out to Furqan at bodarnifurqan07@gmail.com!",
    "That's an interesting question! I can help with questions about Furqan's:\n\n• Skills & expertise\n• Projects & portfolio\n• Services & pricing\n• Contact & hiring\n\nWhat would you like to know?",
    "I don't have specific info on that, but try asking about skills, projects, or services! Or contact Furqan directly.",
  ],

  thanks: [
    "You're welcome! 😊 Let me know if you have any other questions about Furqan.",
    "Happy to help! Feel free to explore more or reach out to Furqan directly.",
...
export const INTENT_KEYWORDS: Record<string, string[]> = {
  ...
  // About/Introduction
  about: ["about", "who", "tell me", "yourself", "furqan", "introduce", "introduction", "what do you do", "describe", "overview", "summary", "bio", "background"],
