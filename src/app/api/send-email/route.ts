...
export async function POST(request: Request) {
  try {
                ...
                <table role="presentation" style="width: 600px; border-collapse: collapse; background-color: #ffffff; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); border-radius: 8px; overflow: hidden;">
                  ...
                  <tr>
                    <td style="padding: 40px 30px;">
                      ...
                      <table role="presentation" style="margin: 30px 0;">
                        <tr>
                          <td style="padding-right: 10px;">
                            <a href="https://furqanbodarni.vercel.app" style="display: inline-block; padding: 14px 24px; background: linear-gradient(135deg, #FF8C00 0%, #FF5F00 100%); color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 14px;">View Portfolio</a>
                          </td>
                          <td>
                            <a href="https://github.com/Furqan-7" style="display: inline-block; padding: 14px 24px; background-color: #333; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 14px;">GitHub Profile</a>
                          </td>
                        </tr>
                      </table>
                      ...
                      <p style="margin: 30px 0 0; color: #666; font-size: 16px; line-height: 1.6;">
                        Best regards,<br>
                        <strong style="color: #333;">Furqan Bodarni</strong><br>
                  ...
                  <tr>
                    <td style="padding: 30px; background-color: #f8f9fa; text-align: center; border-top: 1px solid #e0e0e0;">
                      ...
                      <p style="margin: 0; color: #999; font-size: 12px;">
                        <a href="mailto:bodarnifurqan07@gmail.com" style="color: #FF8C00; text-decoration: none; margin: 0 10px;">Email</a> |
                        <a href="https://www.linkedin.com/in/furqan-bodarni-132378327/" style="color: #FF8C00; text-decoration: none; margin: 0 10px;">LinkedIn</a> |
                        <a href="https://github.com/Furqan-7" style="color: #FF8C00; text-decoration: none; margin: 0 10px;">GitHub</a>
                      </p>
    ...
    await transporter.sendMail({
      from: `"Furqan Bodarni" <${EMAIL_USER}>`,
      to: email,
