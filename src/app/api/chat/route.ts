...
const QUICK_RESPONSE_INTENTS: Record<string, string> = {
  ...
  'who are you': 'about', 'who is Furqan': 'about', 'tell me about yourself': 'about',
  'tell me about Furqan': 'about', 'introduce yourself': 'about', 'what do you do': 'about',
  ...
  switch (primaryIntent) {
    ...
    case 'frontend': {
      ...
      responses.push(
        ...
        `Furqan specializes in building responsive, performant, and beautiful user interfaces.`
      );
      break;
    }
    ...
    case 'database': {
      ...
      responses.push(
        ...
        `Furqan designs efficient schemas, writes optimized queries, and handles database migrations.`
      );
      break;
    }
    ...
    case 'ai': {
      ...
      responses.push(
        ...
        `Furqan integrates AI capabilities into production applications, like this very chatbot!`
      );
      break;
    }
    ...
    case 'experience': {
      ...
      responses.push(
        `**Furqan's Journey (${personal.yearsOfExperience} years)**\n\n` +
        `${journeyText}\n\n` +
    ...
    case 'education': {
      responses.push(
        ...
        `Furqan started coding in 2022 and has been continuously learning and building since then. ` +
    ...
    case 'hire': {
      ...
      const available = personal.availableForWork
        ? "✅ **Yes, Furqan is currently available for work!**"
        : "⏳ Furqan is currently busy with existing commitments.";
      ...
      responses.push(
        ...
        `3. Furqan responds within ${personal.responseTime}\n\n` +
        `👉 **Quick Link:** [Go to Contact Section](${sections.contact.link})\n\n` +
    ...
    case 'location': {
      ...
      responses.push(
        ...
        `Furqan works with clients worldwide and is flexible with timezones!`
      );
      break;
    }
    ...
    case 'fun': {
      ...
      responses.push(
        `**Fun Fact:** ${randomFact}\n\n` +
        `**Interests:** ${interests}\n\n` +
        `Outside of coding, Furqan loves exploring new technologies and building products that solve real problems!`
      );
      break;
    }
    ...
    default:
      ...
      return "I'm here to help! Try asking about Furqan's skills, projects, experience, or how to contact him.";
  }
