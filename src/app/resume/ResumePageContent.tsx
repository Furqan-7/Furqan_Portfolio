      ...
      <Container className="relative z-10 max-w-6xl mx-auto px-4 xs:px-5 sm:px-6 md:px-8">
        ...
        >
          ...
          {isMobile ? (
            ...
            <div className="relative w-full h-[80vh] overflow-hidden rounded-2xl bg-[#09080A] border border-white/[0.06]">
              <iframe
                id="resume-pdf-frame"
                src="/Resume/Furqan_Resume.pdf#toolbar=0&navpanes=0&scrollbar=1&view=FitH"
                className="w-full h-full border-0 bg-[#09080A]"
                title="Furqan Bodarni Curriculum Vitae"
              />
            </div>
          )}
        </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mt-8 text-[11px] font-mono text-white/35">
          <div className="flex items-center gap-1.5">
            ...
            <span>Furqan Bodarni • Computer Science</span>
          </div>
          <div className="flex gap-4">
            <a href="https://github.com/Furqan-7" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">GitHub</a>
            <a href="https://www.linkedin.com/in/furqan-bodarni-132378327/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">LinkedIn</a>
          </div>
        </div>
