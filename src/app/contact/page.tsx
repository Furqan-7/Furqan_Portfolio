...
const socialBentoData: SocialBentoItem[] = [
  ...
  },
  {
    id: 'linkedin',
    name: 'LinkedIn',
    handle: 'Furqan Bodarni',
    url: 'https://www.linkedin.com/in/furqan-bodarni-132378327/',
    icon: Linkedin,
  ...
  },
  {
    ...
    name: 'Instagram',
    handle: '@mr__furqan7',
    url: 'https://www.instagram.com/mr__furqan7/',
    icon: Instagram,
  ...
  },
  {
    id: 'email',
    name: 'Email',
    handle: 'bodarnifurqan07@gmail.com',
    url: 'mailto:bodarnifurqan07@gmail.com',
    icon: Mail,
  ...
  },
  {
    id: 'phone',
    name: 'Phone',
    handle: '+91 9743967986',
    url: 'tel:+919743967986',
    icon: Phone,
            ...
            >
              ...
              <div className="flex justify-between items-center border-b border-neutral-100 pb-2.5 z-10 mt-1">
                <div className="flex items-center gap-1.5">
                  <span className="text-[10px] font-extrabold tracking-[0.15em] text-neutral-800 font-jakarta">F</span>
                  <span className="text-[9px] font-bold tracking-[0.1em] text-neutral-500 font-jakarta">BODARNI</span>
                </div>
