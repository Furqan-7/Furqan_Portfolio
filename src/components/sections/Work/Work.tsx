...
export default function Work() {
  ...
  return (
    ...
    >
      ...
      {/* SEO Microdata */}
      <meta itemProp="name" content="Featured Projects - Furqan Bodarni Portfolio" />
      <meta
        itemProp="description"
        content="Showcase of full-stack and AI-focused web development projects built with React, Next.js, TypeScript, and modern scalable architecture."
      />
      <meta itemProp="author" content="Furqan Bodarni" />

      {/* Hidden SEO Content */}
      <div className="sr-only">
        <h2>Featured Projects Portfolio - Full Stack & AI Web Development</h2>
        <p>
          Explore a curated collection of production-ready applications built by Furqan
          Bodarni, highlighting modern full stack engineering and AI-focused product development.
        </p>
