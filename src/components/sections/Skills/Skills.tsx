...
export default function Skills() {
  ...
  return (
    ...
    >
      ...
      {/* SEO Microdata */}
      <meta itemProp="name" content="Technical Skills - Furqan Bodarni" />
      <meta itemProp="description" content="Comprehensive list of programming languages, frameworks, and technologies mastered by Furqan Bodarni including React, Next.js, TypeScript, Node.js, Python, and modern web development tools." />
      ...
      <div className="sr-only">
        ...
        <p>
          Furqan Bodarni is proficient in a wide range of modern web development technologies,
