...
export default function Contact() {
  ...
  return (
    ...
    >
      ...
      {/* SEO Microdata */}
      <meta itemProp="name" content="Contact Furqan Bodarni - Full Stack Developer" />
      <meta itemProp="description" content="Get in touch with Furqan Bodarni for full-time opportunities, freelance projects, or collaboration. Available for web development, React, Next.js, and full-stack development projects." />
      ...
      <div className="sr-only">
        <h2>Contact Furqan Bodarni - Full Stack Developer</h2>
        
        <h3>Get in Touch</h3>
        <p>
          Furqan Bodarni is available for full-time roles, freelance projects, and consulting opportunities. 
