            ...
            text: (
              <div className="font-mono text-[11px] sm:text-xs text-white/80 py-1 space-y-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-1.5 text-white/70">
                  ...
                  <div><span className="text-white font-bold inline-block w-20">weather</span> <span className="text-white/40">Udupi weather report</span></div>
          ...
          ...prev,
          {
            ...
            text: (
              <div className="space-y-1 text-white/80 py-0.5 text-xs sm:text-sm">
                <p><span className="text-[#FF8C00] font-bold">Name:</span> Furqan Bodarni</p>
                <p><span className="text-[#FF8C00] font-bold">Title:</span> Full Stack & AI Developer</p>
                <p><span className="text-[#FF8C00] font-bold">Location:</span> Udupi, Karnataka, India (IST)</p>
       ...
       \\  _  /
        \\___/`}
                ...
                <div className="space-y-0.5 text-white/80">
                  <p><span className={`${activeTheme.accentColor} font-bold`}>OS:</span> FurqanOS v1.0 (iOS Hybrid)</p>
          ...
          ...prev,
          {
            ...
            text: (
              <div className="py-1 text-xs font-mono text-white/80">
                <p className="text-emerald-400 font-bold mb-1">WEATHER: Udupi, Karnataka, India</p>
  ...
  ― (   ) ―    Tue:     ☀️  Sunny (31°C)
     \`-\`       Humidity: 42% | Wind: 12 km/h ENE`}
      ...
      case 'sudo clear':
        setLogs(prev => [
          ...prev,
          { type: 'error', text: '🔒 guest is not in the sudoers file. This incident will be reported to Furqan.' }
        ]);
        break;
            ...
            text: (
              <div className="p-3.5 rounded-2xl bg-[#39d353]/[0.06] border border-[#39d353]/30 shadow-[0_0_20px_rgba(57,211,83,0.15)] my-2 font-mono">
                ...
                <div className="space-y-1 text-[11px] sm:text-xs text-white/90">
                  <p><span className="text-[#39d353] font-bold">NAME:</span> Furqan Bodarni</p>
            ...
            >
                  ...
                  <div key={index} className="text-xs sm:text-sm leading-relaxed whitespace-pre-wrap break-all">
                    {log.type === 'input' && (
                      <div className="flex items-start">
                        <span className={`${activeTheme.promptColor} font-bold mr-2 select-none`}>guest@furqan.dev:~$</span>
              ...
              <div className="p-4 bg-white/[0.02] border-t border-white/[0.08]">
                <div className="flex items-center">
                  <span className={`${activeTheme.promptColor} font-bold text-xs sm:text-sm mr-2 select-none`}>guest@furqan.dev:~$</span>
