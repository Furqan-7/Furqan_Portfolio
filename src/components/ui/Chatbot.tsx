  ...
  useEffect(() => {
    if (isOpen && messages.length === 0) {
      setMessages([
        {
          id: '1',
          content: "Hey there! 👋 I'm Furqan's AI assistant. I can tell you all about his skills, projects, experience, and more. What would you like to know?",
          role: 'assistant',
          timestamp: new Date(),
        },
      ]);
  ...
  const sendMessage = async (messageText: string) => {
    ...
    try {
      ...
      const errorMessage: Message = {
        id: (Date.now() + 1).toString(),
        content: "Sorry, I'm having trouble responding right now. Please try again or contact Furqan directly at bodarnifurqan07@gmail.com",
        role: 'assistant',
        timestamp: new Date(),
      };
