...
const socialLinks = [
  { name: 'GitHub', url: 'https://github.com/Furqan-7', icon: Github, color: '#FFFFFF' },
  { name: 'LinkedIn', url: 'https://www.linkedin.com/in/furqan-bodarni-132378327/', icon: Linkedin, color: '#0A66C2' },
  { name: 'Instagram', url: 'https://www.instagram.com/mr__furqan7/', icon: Instagram, color: '#E4405F' },
  { name: 'Email', url: 'mailto:bodarnifurqan07@gmail.com', icon: Mail, color: '#30D158' },
];
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 md:gap-4">
            ...
            <div className="flex flex-col gap-2.5">
              <div className="flex items-center gap-3">
                ...
                >
                  <span className="text-white">Furqan</span>{' '}
                  <span className="text-white italic">Bodarni</span>
                </span>
